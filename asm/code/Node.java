...
/**
 * Abstract class Node. Includes label, mnemonic and comment. Podporni razred za
...
public abstract class Node {
    ...
    public String toString() {
        String rtn = String.format("%-6s   %-6s   %-6s", (label != null ? label : " "), mnemonic.toString(), operandToString());
        return rtn;
    }
